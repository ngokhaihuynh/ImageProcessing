...
public:
    ...
    QPushButton *btn_Loc_laplace_Gau;
    QPushButton *btn_Loc_G_L;
    QPushButton *btn_gtTuanTu;
    QPushButton *btn_gtOlsu;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btn_Loc_laplace_Gau = new QPushButton(centralWidget);
        btn_Loc_laplace_Gau->setObjectName(QStringLiteral("btn_Loc_laplace_Gau"));
        btn_Loc_laplace_Gau->setGeometry(QRect(920, 380, 191, 31));
        btn_Loc_G_L = new QPushButton(centralWidget);
        btn_Loc_G_L->setObjectName(QStringLiteral("btn_Loc_G_L"));
        btn_Loc_G_L->setGeometry(QRect(920, 420, 191, 31));
        btn_gtTuanTu = new QPushButton(centralWidget);
        btn_gtTuanTu->setObjectName(QStringLiteral("btn_gtTuanTu"));
        btn_gtTuanTu->setGeometry(QRect(880, 250, 221, 31));
        btn_gtOlsu = new QPushButton(centralWidget);
        btn_gtOlsu->setObjectName(QStringLiteral("btn_gtOlsu"));
        btn_gtOlsu->setGeometry(QRect(880, 290, 221, 31));
        btn_Anmon = new QPushButton(centralWidget);
        btn_Anmon->setObjectName(QStringLiteral("btn_Anmon"));
        btn_Anmon->setGeometry(QRect(160, 590, 151, 41));
        btn_Gianno = new QPushButton(centralWidget);
        btn_Gianno->setObjectName(QStringLiteral("btn_Gianno"));
        btn_Gianno->setGeometry(QRect(390, 590, 171, 41));
        btn_Open = new QPushButton(centralWidget);
        btn_Open->setObjectName(QStringLiteral("btn_Open"));
        btn_Open->setGeometry(QRect(610, 590, 191, 41));
        btn_close = new QPushButton(centralWidget);
        btn_close->setObjectName(QStringLiteral("btn_close"));
        btn_close->setGeometry(QRect(850, 590, 161, 41));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        btn_Loc_laplace_Gau->setText(QApplication::translate("MainWindow", "Gauss + laplace", 0));
        btn_Loc_G_L->setText(QApplication::translate("MainWindow", "G + L  anh mau", 0));
        btn_gtTuanTu->setText(QApplication::translate("MainWindow", "Gi\341\272\243i thu\341\272\255t tu\341\272\247n t\341\273\261", 0));
        btn_gtOlsu->setText(QApplication::translate("MainWindow", "Gi\341\272\243i thu\341\272\255t Olsu", 0));
        btn_Anmon->setText(QApplication::translate("MainWindow", "\304\202n m\303\262n", 0));
        btn_Gianno->setText(QApplication::translate("MainWindow", "Gi\341\272\243n n\341\273\237 ", 0));
